...
//The only purpose of this component is to explore the life cycle of component based implementation
//of react components

class AnotherUserClass extends React.Component{
    constructor(props){
        super(props);
...
export default AnotherUserClass;